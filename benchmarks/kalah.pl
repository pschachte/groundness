% CVS: $Id: kalah.pl,v 1.3 1998/10/20 03:23:35 pets Exp $
goal :- play(Game,Result).
...
genlegal([A,B,C,D,E,F]) :-
    genlegal1([A,B,C,D,E,F]).
...
initialize(kalah,board([0,1,2,1,2,0],4,[0,0,0,0,0,0],0),opponent).
initialize(kalah,board(W,X,R,Z),opponent).
