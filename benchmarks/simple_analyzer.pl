% CVS: $Id: simple_analyzer.pl,v 1.3 1998/10/20 03:23:52 pets Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
/*	Fixing up missing 'C' predicate used by the
	Definite Clause Grammar stuff.
*/
%'C'([X|S],X,S).
